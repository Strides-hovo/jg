...
document.addEventListener("DOMContentLoaded", function(){
	...
	endDate.setMonth(curDate.getMonth()+plusM);
	eDay = endDate.getDate();
	eMon = endDate.getMonth();
	eYea = endDate.getFullYear();
	daysDelta = Math.abs(endDate - curDate)/1000/60/60/24;
	if (eMon != cMon + plusM){
		eMon = cMon + plusM;
		eDay = cDay - 1;
	}
	...
	investInput.addEventListener("keydown", function(e){
		if (e.keyCode!=8 && e.keyCode!=49 && e.keyCode!=50 && e.keyCode!=51 && e.keyCode!=52 && e.keyCode!=53 && e.keyCode!=54 && e.keyCode!=55 && e.keyCode!=56 && e.keyCode!=57 && e.keyCode!=48 && e.keyCode!=96 && e.keyCode!=97 && e.keyCode!=98 && e.keyCode!=99 && e.keyCode!=100 && e.keyCode!=101 && e.keyCode!=102 && e.keyCode!=103 && e.keyCode!=104 && e.keyCode!=105 && e.keyCode!=190 && e.keyCode!=13){
			e.preventDefault();
			e.stopPropagation();
			return;
		}
...
function slideChange(e){
	...
	if (sliderElement.id=="slider1"){
		...
		eDay = endDate.getDate();
		eMon = endDate.getMonth();
		if (curDate.getMonth()+plusM>11) eYea = curDate.getFullYear() + 1;
		else eYea = curDate.getFullYear();
		if (cDay == 31 && (eMon != cMon + plusM - 1)){
			switch (eMon){
				case 0:
					eDay = 31;
					break;
